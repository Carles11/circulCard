...
const DeleteRelationalProduct = ({
  products,
  IconButton,
  ConfirmDialog,
  handleDeleteRelationalProduct,
}: {
  products: any
  IconButton: any
  ConfirmDialog: any
  handleDeleteRelationalProduct: Function
}) => {
  const [confirmOpen, setConfirmOpen] = useState<number | null>(null)

  return (
    <div className="flex flex-col p-4 text-foreground  ">
      <h4>Pulsa sobre el icono para desvincularlo de este cliente.</h4>
            ...
            >
              ...
              <div>
                ...
                <ConfirmDialog
                  ...
                  onConfirm={() => handleDeleteRelationalProduct(item.id)}
                >
...
export default DeleteRelationalProduct
